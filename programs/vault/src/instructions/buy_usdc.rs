...
pub fn buy_usdc(ctx: Context<BuyUsdc>, amount: u64) -> Result<()> {
    require!(amount >= 10 * 1000, VaultError::XusdAmountTooSmall);
    ...
    token::transfer_checked(
        CpiContext::new(
            ...
            TransferChecked {
                ...
                from: ctx.accounts.swapper_xusd_ata.to_account_info(),
    ...
    token::transfer_checked(
        CpiContext::new_with_signer(
            ...
            TransferChecked {
                ...
                to: ctx.accounts.swapper_usdc_ata.to_account_info(),
    ...
    vault.usdc_assets = vault.usdc_assets.checked_add(vault_fee).ok_or(VaultError::MathOverflow)?;
